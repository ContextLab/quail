...
class quail(object):
    ...
    def __init__(self,  Egg=Egg, load=load, load_example_data=load_example_data, analyze=analyze, plot=plot, stack_eggs=stack_eggs, crack_egg=crack_egg, recmat2egg=recmat2egg):
        self.Egg = Egg
        self.load = load
