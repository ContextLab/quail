...
Computation times
=================
**00:07.285** total execution time for 14 files **from auto_examples**:
...
.. container::
   ...
   * - :ref:`sphx_glr_auto_examples_crack_egg.py` (``crack_egg.py``)
     - 00:00.000
     - 0.0
   * - :ref:`sphx_glr_auto_examples_create_egg.py` (``create_egg.py``)
     - 00:00.000
     - 0.0
   * - :ref:`sphx_glr_auto_examples_create_multisubject_egg.py` (``create_multisubject_egg.py``)
     - 00:00.000
     - 0.0
   * - :ref:`sphx_glr_auto_examples_decode_speech.py` (``decode_speech.py``)
     - 00:00.000
     - 0.0
