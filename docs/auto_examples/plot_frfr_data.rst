...
.. "auto_examples/plot_frfr_data.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_plot_frfr_data.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_plot_frfr_data.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 39-238
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /auto_examples/images/sphx_glr_plot_frfr_data_001.png
         :alt: FRFR Dataset: Recall Analyses by Condition (Early vs Late Lists), Probability of First Recall (Early Lists), Lag-CRP (Early Lists), Serial Position Curve (Early Lists), Probability of First Recall (Late Lists), Lag-CRP (Late Lists), Serial Position Curve (Late Lists)
         :srcset: /auto_examples/images/sphx_glr_plot_frfr_data_001.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/images/sphx_glr_plot_frfr_data_002.png
         :alt: Memory fingerprints Early lists, Late lists
         :srcset: /auto_examples/images/sphx_glr_plot_frfr_data_002.png
         :class: sphx-glr-multi-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Loaded FRFR data: 452 subjects, 16 lists, 16 items per list
    ...
    Early lists egg: 452 subjects, 8 lists
    Late lists egg: 452 subjects, 8 lists

    ============================================================
    Creating Figure 1: PFR, Lag-CRP, SPC by condition
    ============================================================

    Analyzing early lists...
      Computing PFR (early)...
      Computing Lag-CRP (early)...
      Computing SPC (early)...

    Analyzing late lists...
      Computing PFR (late)...
      Computing Lag-CRP (late)...
      Computing SPC (late)...

    Saved Figure 1 to frfr_recall_analysis.png

    ============================================================
    Creating Figure 2: Memory Fingerprints by condition
    ============================================================

    Computing fingerprints (early lists)...
    Computing fingerprints (late lists)...
    Saved Figure 2 to frfr_fingerprint_analysis.png
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (1 minutes 31.195 seconds)


.. _sphx_glr_download_auto_examples_plot_frfr_data.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_frfr_data.ipynb <plot_frfr_data.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_frfr_data.py <plot_frfr_data.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_frfr_data.zip <plot_frfr_data.zip>`
