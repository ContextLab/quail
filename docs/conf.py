...
author = u'Andrew C. Heusser, Kirsten Ziman, Jeremy R. Manning'
...
# further.  For a list of options available for each theme, see the
# documentation.
extlinks = {'github': 'https://github.com/ContextLab/pyrec'}
...
latex_documents = [
    (master_doc, 'quail.tex', u'quail Documentation',
...
man_pages = [
    (master_doc, 'quail', u'quail Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'quail', u'quail Documentation',
     author, 'quail', 'One line description of project.',
     'Miscellaneous'),
]
